...
var _PhotoSwipeComponentJs = require('./PhotoSwipeComponent.js');

var _PhotoSwipeComponentJs2 = _interopRequireDefault(_PhotoSwipeComponentJs);
  ...
  _createClass(PhotoSwipeGallery, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_PhotoSwipeComponentJs2['default'], _extends({}, eventProps, {
          isOpen: isOpen,
          items: items,
          options: options,
